...
function removeLastFlavor(pickarray) {
  originalFlavors.pop();
...
function getFlavorByIndex(arr1, index) {
  console.log(arr1.slice(1, index));
}
...
function removeFlavorByName(arr3, flavor) {
  arr3.splice(arr3.indexOf(flavor), 1);
  console.log(arr3);
}
...
console.log(copy("newarr", originalFlavors).reverse());
...
function filterByWord(original, pickflave) {
  let filterArr = [];

  for (let i = 0; i < original.length; i++) {
    if (original[i].includes(pickflave)) {
...
console.log(filterByWord(originalFlavors, "Chocolate").reverse());
